                                    ...
                                    <div className="row">
                                        <div className="col-2">
                                            {props.shelfCurrentLoan.book?.img 
                                                ?
                                                <img width="56" height="87" src={props.shelfCurrentLoan.book?.img}/>
                                                :
                                                <img width="56" height="87" src={require("./../../image/image-book/new-book-1.jpg")}/>
                                            }
                                        </div>
                                    ...
                                    <hr/>
                                        ...
                                        <div className="list-group mt-3">
                                            ...
                                            <button onClick={
                                                ...
                                                "list-group-item list-item-action inactiveLink":
                                                "list-group-item list-group-item-action"}>
                                                {
                                                    props.shelfCurrentLoan.daysLeft < 0 ?
                                                    "Late dues cannot be renewed":"loan for 7 days"
                                                }
                                            </button>
                                        </div>
                                </div>
