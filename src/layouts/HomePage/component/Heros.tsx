                    ...
                    <div className="row g-0 mt-5">
                        ...
                        <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                            <div className="ml-2">
                                ...
                                whether it is to learn a new skill or grow within one, we will be able to provide the top
                                content for you!
                                </p>
                    ...
                    <div className="m-2">
                        ...
                        <div className="mt-2">
                            ...
                            <p className="lead">
                                ...
                                We work nonstop to provide the most accurate book selection possible
                                for our Luv 2 Read students! We are diligent about our book selection
                                and our book selection an our books are always going to be our top priority.
                            </p>
                        </div>
                    </div>
                </div>
